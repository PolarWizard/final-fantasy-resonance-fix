...
// Function BP_BtlCmdList_Item.BP_BtlCmdList_Item_C.Initialize
// 0x0088 (0x0088 - 0x0000)
struct BP_BtlCmdList_Item_C_Initialize final
{
public:
	...
	TMap<int32, int32>                            CallFunc_GetConsumableItemList_outItemList;        // 0x0010(0x0050)()
	...
	struct FActionKey                             K2Node_MakeStruct_ActionKey;                       // 0x007C(0x0008)(NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Add_ReturnValue;                    // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_BtlCmdList_Item_C_Initialize;
