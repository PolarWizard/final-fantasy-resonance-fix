...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const int32                             MaxSize                                                (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UManaComponent::SetMaxPictureDataSize(const int32 MaxSize)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ManaComponent", "SetMaxPictureDataSize");

	Params::ManaComponent_SetMaxPictureDataSize Parms{};
...
int32 UManaMovie::GetMaxPictureDataSize() const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ManaMovie", "GetMaxPictureDataSize");

	Params::ManaMovie_GetMaxPictureDataSize Parms{};
