...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09D76D50;
	constexpr int32 AppendString      = 0x01376360;
	constexpr int32 GNames            = 0x09C5A678;
	constexpr int32 GWorld            = 0x09A92540;
	constexpr int32 ProcessEvent      = 0x01592D00;
